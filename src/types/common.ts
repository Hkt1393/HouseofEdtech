/**
 * Shared primitive, platform, and theme-engine contracts used across the app.
 */
...
/**
 * Standard identifier type used across domain models.
 */
...
/**
 * Shared loading lifecycle states for asynchronous UI.
 */
...
/**
 * Pagination request parameters shared by list endpoints.
 */
...
/**
 * Supported media families rendered by the streaming experience.
 */
...
/**
 * Semantic design tokens for theme-aware surfaces and text.
 */
...
/**
 * Global spacing scale shared by layouts and components.
 */
...
/**
 * Global radius scale shared by cards, sheets, and pills.
 */
...
/**
 * Typography tokens shared by the design system.
 */
...
/**
 * Motion tokens shared by transitions and feedback animations.
 */
...
/**
 * Fully resolved theme object exposed by the ThemeProvider.
 */
...
/**
 * Theme context value consumed by app screens and components.
 */
...
/**
 * Provider props for the centralized theme engine.
 */
